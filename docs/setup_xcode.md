...
This tutorial uses command line tools.  If you haven't installed CLI tools on your machine yet, follow the macOS CLI setup tutorial below:

[macOS](setup_macos.html)
